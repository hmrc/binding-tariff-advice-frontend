...
class SessionIdFilterTest extends WordSpec with MustMatchers with OneAppPerSuite {

  import SessionIdFilterTest._
  ...
  override lazy val app: Application = {
    ...
    new GuiceApplicationBuilder()
      .overrides(
        bind[HttpFilters].to[SessionIdFilterTest.Filters],

...
class GoodDetailsControllerTest extends ControllerSpec {
  ...
  private def controller(advice: Advice) = new GoodDetailsController(
  ...
  "GET /" should {
    ...
    "return 200" in {
      ...
      bodyOf(result) should include("good_details-heading")
    }
  }
  ...
  "POST /" should {
    ...
    "return 200 and redirect on valid form" in {
      ...
      val request = postRequestWithCSRF.withFormUrlEncodedBody("item-name" -> "name", "description" -> "description")
